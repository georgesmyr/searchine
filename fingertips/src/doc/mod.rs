...
pub(crate) struct DocumentTermsCounterBuilder {
    doc_term_counts: HashMap<usize, usize>,
}

impl DocumentTermsCounterBuilder {
    /// Inserts the number of terms for a document with specified
    /// document ID.
    pub(crate) fn insert_doc_terms(&mut self, doc_id: usize, n_terms: usize) {
...
impl DocumentTermsCounter {
    ...
    /// it returns None.
    pub(crate) fn get_doc_terms(&self, doc_id: usize) -> usize {
